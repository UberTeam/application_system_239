...
class BikeCrossForm extends FormBase {

    public function getFormId() {
        return 'bike_cross_form';
    }
...
//        Специальное оборудование
        ...
        $form['special_eq_container']['special_eq'] = \Drupal::formBuilder()->getForm('Drupal\application\Form\BikeCrossEq');
