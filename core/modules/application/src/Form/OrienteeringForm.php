...
class OrienteeringForm extends FormBase {

    public function getFormId() {
        return 'orienteering_form';
    }
...
//        Специальное оборудование
        ...
        $form['special_eq_container']['special_eq'] = \Drupal::formBuilder()->getForm('Drupal\application\Form\OrienteeringEq');
