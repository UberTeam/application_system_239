...
class ObstacleForm extends FormBase {

    public function getFormId() {
        return 'obstacle_form';
    }
...
//        Специальное оборудование
        ...
        $form['special_eq_container']['special_eq'] = \Drupal::formBuilder()->getForm('Drupal\application\Form\ObstacleEq');
